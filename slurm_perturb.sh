...
#SBATCH -J perturb # A single job name for the array
...
#SBATCH -o LOG_perturb.out # Standard output - write the console output to the output folder %A= Job ID, %a = task or Step ID
#SBATCH -e LOG_perturb.err # Standard error -write errors to the errors folder and
