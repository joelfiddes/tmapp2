...
#SBATCH -o LOG_svf-%A.out # Standard output - write the console output to the output folder %A= Job ID, %a = task or Step ID
#SBATCH -e LOG_svf-%A.err # Standard error -write errors to the errors folder and
