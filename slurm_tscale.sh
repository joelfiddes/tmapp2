...
#SBATCH -o SLURM_tscale-%A.out # Standard output - write the console output to the output folder %A= Job ID, %a = task or Step ID
#SBATCH -e SLURM_tscale-%A.err # Standard error -write errors to the errors folder and
