...
#SBATCH -J tscale # A single job name for the array
...
#SBATCH -o LOG_tscale.out # Standard output - write the console output to the output folder %A= Job ID, %a = task or Step ID
#SBATCH -e LOG_tscale.err # Standard error -write errors to the errors folder and
...
# Calculate the starting and ending values for this task based (indexing starts at 1)
...
#for (( run=$START_NUM; run<=END_NUM; run++ )); do
  ...
  #Do your stuff here
python ../tcale_evo/tscale_points.py $1 $START_NUM $END_NUM
