...
s =shapefile("/home/joel/sim/barandunPaper/amu_points/spatial/TJ1981over2000.shp")
...
if (DOWNLOAD==TRUE){
	...
	inDir=paste0("/home/joel/sim/barandunPaper/amu_points/sim/g",gdir,"/out/FSM/")
	...
	#mete
	met=read.csv(paste0("/home/joel/sim/barandunPaper/amu_points/sim/g",gdir,"/forcing/meteoc1.csv"))
