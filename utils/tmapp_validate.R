...
if (mode == 'basins'){
    wd="/home/joel/sim/tmapp_val/basins/sim1/"
    sim="g7"
}

if (mode == 'grid'){
    wd="/home/joel/sim/tmapp_val/grids/sim1/"
    sim="g18"
}

#simPath="/home/joel/sim/ch_basin/sim/g3"
simPath=paste0(wd,"/sim/",sim)
...
pdf(paste0(simPath,"/valResults_",mode,".pdf"))
par(mfrow=c(4,4))
...
HS.gt = gt$snow_depth.mm.[start:end]/1000
    ...
    rms=round(rmse(sim=HS.gt, obs=HS.imis),2)

plot(HS.gt, type='l', col='red', main=paste0(imisID, "/", rms))
lines(HS.imis)

    legend("topright", c("MOD", "OBS"), col=c("red", "black"),lty=1 )
}
dev.off()
